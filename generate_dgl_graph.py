...
if __name__ == '__main__':
    ...
    # Automatically select all event attributes except 'time:timestamp'
    list_e_a = [attr for attr in event_attributes if attr != 'time:timestamp']
    list_e_a.append('timesincecasestart')  # Add 'timesincecasestart'

    # Automatically select all case attributes except 'case:concept:name'
    list_c_a = [attr for attr in case_attributes if attr != 'case:concept:name']
